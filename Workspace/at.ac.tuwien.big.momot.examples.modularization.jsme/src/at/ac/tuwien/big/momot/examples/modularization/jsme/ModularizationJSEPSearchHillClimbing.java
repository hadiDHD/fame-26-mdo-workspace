...
public class ModularizationJSEPSearchHillClimbing {
   ...
   public static void main(final String... args) {
      init();
      final ModularizationJSEPSearchHillClimbing search = new ModularizationJSEPSearchHillClimbing();
   ...
   protected IFitnessDimension<TransformationSolution> _createObjective_5(
         final TransformationSearchOrchestration orchestration) {
      final IFitnessDimension dimension = _createObjectiveHelper_5();
   ...
   protected double _createObjectiveHelper_0(final TransformationSolution solution, final EObject root) {
      double _xblockexpression = 0;
      {
         final ModularizationCalculator calculator = solution.<ModularizationCalculator> getAttribute(
               ModularizationJSEPSearchHillClimbing.attribute, ModularizationCalculator.class);
   ...
   protected IEGraphMultiDimensionalFitnessFunction createFitnessFunction(
         final TransformationSearchOrchestration orchestration) {
      final IEGraphMultiDimensionalFitnessFunction function = new ModularizationJSEPSearchHillClimbing.ModularizationJSEPFitnessFunction();
   ...
   protected TransformationSearchOrchestration createOrchestration(final String initialGraph,
      ...
      orchestration.addAlgorithm("RandomDescent",
            local.createRandomDescent(new IncreasingNeighborhoodFunction(orchestration.getSearchHelper(), 100),
   ...
   protected TransformationResultManager handleResults(final SearchExperiment experiment) {
      ...
      resultManager.saveObjectives("data/output/approximationSet/mtunis_randomDescent.pf");
